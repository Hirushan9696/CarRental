    ...
    const fetchVehicles = async () => {
      if (vehicleType) {
        try {
          ...
          setSelectedVehicle(""); // Reset selected vehicle when vehicle type changes
        } catch (error) {
          console.error("Error fetching vehicles:", error);
          setError("Failed to fetch vehicles.");
        }
      } else {
        setVehicles([]); // Clear vehicles if no vehicle type is selected
        ...
        <Card.Body>
          ...
          <Form onSubmit={handleUpdate}>
            ...
            <Form.Group className="text-center">
              <Button variant="dark" type="submit">Update Booking</Button>
            </Form.Group>
          </Form>
        </Card.Body>
      </Card>
