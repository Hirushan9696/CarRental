...
const DriverDashboard = () => {
    ...
    return (
        <Container className="mt-5">
            <h1 className="h3 mb-4 text-center text-dark fw-bold">Driver Dashboard</h1>
                    ...
                    {bookings.map((booking) => (
                        <ListGroup.Item key={booking.id} className="mb-3">
                            <Card className="shadow-lg">
                                <Card.Body>
                                    <Card.Title className="text-success fw-bold">Assigned Booking Order</Card.Title>
                                    ...
                                    <div className="mt-3 text-center">
                                        <Button variant="success" size="lg" className="rounded-pill px-4" onClick={() => handlePickup(booking.bookingId)}>
                                             Pickup
                                        </Button>
                                    </div>
                                </Card.Body>
