...
import NavBar from "./components/NavBar"; // Regular NavBar for customer routes
import AdminNavBar from "./components/AdminNavBar"; // AdminNavBar for admin routes
import DriverNavBar from "./components/DriverNavBar"; // DriverNavBar for driver routes
...
import { AboutUs, ContactUs } from "./pages/HomePage"; // Import AboutUs and ContactUs
